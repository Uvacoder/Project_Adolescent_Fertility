...
#scrollytell 
.step .step-content .step-content-inner .highlight{color:#e7696f;font-weight:700}@media only screen and (min-width:601px){#scrollytell 
  .step .step-content{background-size:360px 360px;}#scrollytell .step .step-content 
  .step-content-inner{font-size:30px;padding:36px;}}#scrollytell.touch-device 
  .scrollama-steps{pointer-events:auto}#scrollytell.touch-device 
  .flourish-container iframe{pointer-events:none}</style><div class="flourish-container"></div>
  <div class="scrollama-steps">${stepsArr
  .map(
    (step) =>
